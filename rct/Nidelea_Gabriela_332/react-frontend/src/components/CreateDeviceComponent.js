...
//  const addDevice = (description,address,max_hourly_energy_consumption, consumerDevice) => {

  //  DeviceService.addDevice(description,address,max_hourly_energy_consumption, consumerDevice).then((res)=>{
const addDevice = (newDevice) => {

        DeviceService.addDevice(newDevice).then((res)=>{
...
const handleSubmit = (e)=>{
    e.preventDefault();
    addDevice(newDevice);      //description,address,max_hourly_energy_consumption, consumerDevice);
